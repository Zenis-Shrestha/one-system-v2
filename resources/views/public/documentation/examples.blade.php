...
<span class="text-green-400">curl</span> -X POST https://cas-server.com/api/sso/token \
...
<span class="text-green-400">curl</span> -X POST https://cas-server.com/api/sso/validate \
  -H <span class="text-amber-300">"Content-Type: application/json"</span> \
...
<section class="mb-12">
  ...
  <span class="text-violet-400">const</span> res = <span class="text-violet-400">await</span> <span class="text-green-400">fetch</span>(<span class="text-amber-300">'https://cas-server.com/api/sso/token'</span>, {
...
<span class="text-violet-400">async function</span> <span class="text-green-400">validateToken</span>(token) {
  <span class="text-violet-400">const</span> res = <span class="text-violet-400">await</span> <span class="text-green-400">fetch</span>(<span class="text-amber-300">'https://cas-server.com/api/sso/validate'</span>, {
    method: <span class="text-amber-300">'POST'</span>,
    headers: { <span class="text-amber-300">'Content-Type'</span>: <span class="text-amber-300">'application/json'</span> },
...
<section class="mb-12">
    ...
    <span class="text-red-300">$ch</span> = <span class="text-green-400">curl_init</span>(<span class="text-amber-300">'https://cas-server.com/api/sso/token'</span>);
...
<span class="text-violet-400">def</span> <span class="text-green-400">generate_token</span>(email, password):
    response = requests.<span class="text-green-400">post</span>(
        <span class="text-amber-300">'https://cas-server.com/api/sso/token'</span>,
        json={
