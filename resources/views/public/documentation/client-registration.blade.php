...
<section id="configure" class="mb-12">
    ...
    <div class="rounded-xl border border-slate-200 overflow-hidden">
        ...
        <div class="bg-slate-900 p-5 overflow-x-auto">
            <pre class="text-sm font-mono text-slate-300 leading-relaxed"><code>CAS_SERVER_URL=https://cas-server.com
...
<section id="test" class="border-t border-slate-200 pt-10">
    ...
    <div class="rounded-xl border border-slate-200 overflow-hidden mb-4">
        <div class="bg-slate-900 p-5 overflow-x-auto">
            <pre class="text-sm font-mono text-slate-300 leading-relaxed"><code>curl -X POST https://cas-server.com/api/sso/token \
