    ...
    <div class="os-card overflow-hidden">
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-[var(--color-line)]">
                ...
                <tr><td class="px-5 py-3 font-mono text-xs text-[var(--color-ink)]">logout(redirectUrl?)</td><td class="px-5 py-3 text-[var(--color-muted)] text-xs font-mono">Promise&lt;void&gt;</td><td class="px-5 py-3 text-[var(--color-ink-2)]">Clear local state, POST CAS logout, then redirect</td></tr>
